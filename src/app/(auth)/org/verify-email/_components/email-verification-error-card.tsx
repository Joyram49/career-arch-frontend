  ...
  return (
    <div className="shadow-modal w-full max-w-sm rounded-3xl border border-border bg-card p-7 text-center sm:max-w-md sm:p-10">
      ...
      <div className="mt-6 space-y-3">
        <Link href={{ pathname: '/org/register' }} className="block">
          <Button className="h-12 w-full rounded-xl">Register your company again</Button>
        </Link>
        <Link href={{ pathname: '/help' }} className="block">
