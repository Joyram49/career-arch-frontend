    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p className="text-[15px] leading-relaxed text-muted-foreground">
          Your employer account password has been updated. You can now sign in and continue managing
      ...
      <div className="w-full rounded-xl border border-brand-emerald/20 bg-brand-emerald/5 p-4 text-left">
        <div className="flex items-start gap-3">
          ...
          <p className="text-xs leading-relaxed text-muted-foreground">
            All existing sessions for your organization have been revoked for security. Please sign
