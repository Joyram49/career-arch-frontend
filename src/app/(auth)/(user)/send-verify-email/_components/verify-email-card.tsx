...
export function VerifyEmailCard({ email }: VerifyEmailCardProps): React.JSX.Element {
  ...
  function handleOpenMailApp(): void {
  ...
  return (
    ...
    >
      ...
      >
        {/* Subtle top gradient shimmer inside card */}
        <div
        ...
        <div className="mb-6 space-y-3 text-center">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground sm:text-[15px]">
            ...
            <span className="font-bold text-foreground">{email}</span>. Click the link inside to get
            started.
          </p>
        </div>

        {/* Open Mail App — mobile prominent CTA */}
        <Button
          type="button"
        ...
        <div className="space-y-3">
          ...
          {resendSuccess && (
            <motion.p
              ...
              exit={{ opacity: 0 }}
              className="bg-brand-emerald-light rounded-lg px-3 py-2 text-center text-xs font-semibold text-brand-emerald"
              role="status"
            >
          ...
          {/* Desktop resend: full bordered button */}
          <button
            type="button"
          ...
          {/* Mobile resend: text link + countdown */}
